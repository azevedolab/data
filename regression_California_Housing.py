...
def write_metrics(X_train,y_train,X_test,y_test,pipeline_in,csv_out):
...
y_test_pred_mlr = write_metrics(X_train,y_train,X_test,y_test,
                                pipeline_mlp,csv_out)
...
y_test_pred_rf = write_metrics(X_train,y_train,
                                        X_test,y_test,pipeline_rf,csv_out)
...
y_test_pred_sgd = write_metrics(X_train,y_train,X_test,y_test,
                                    pipeline_sgd,csv_out)
